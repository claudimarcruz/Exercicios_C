...
int main(){
    ...
    insertTree(&t, 20); /* insere o elemento 20 na árvore */
    insertTree(&t, 2); /* insere o elemento 2 na árvore */
    insertTree(&t, 4); /* insere o elemento 4 na árvore */
    insertTree(&t, 70); /* insere o elemento 70 na árvore */
    insertTree(&t, 55); /* insere o elemento 55 na árvore */
    insertTree(&t, 9); /* insere o elemento 9 na árvore */
    ...
    if(busca(t, 15)!=NULL) { /* Verifica se o número 15 pertence a árvore */
        printf("\nO numero 15 pertence a arvore!\n");
    }else{
        printf("\nO numero 15 NAO pertence a arvore!\n");
    }

    if(busca(t, 22)!=NULL) { /* Verifica se o número 22 pertence a árvore */
